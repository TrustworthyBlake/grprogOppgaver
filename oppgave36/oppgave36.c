 ...
 *   Programeksempel nr 33 - Pekere - Liste (Last-In-First-Out (LIFO),
                                             stakk/stack).
        !!-!! Modifisert til FIFO av Andreas Blakli som angitt i oppgave 36 !!-!!
 *
 *   @file     EKS_33.C
...
int main() {
    struct Person
        *personListe,  //  Peker til HELE listen.
        *persPeker,    //  Peker til EN aktuell Person.
        *siste;        //  Peker til siste person i listen.
